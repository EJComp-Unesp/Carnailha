...
module.exports = {
    generatePage: function (pageContent) {
        ...
        console.log('   Cleaning previous news...');
        try {
        ...
        pageContent.hasOwnProperty('newsa')
            ? pageContent.newsa.length
                ? pageContent.newsa.map((news, index) => {
                    if (index == 0) {
                        previous = news;
                    }
                    fs.writeFileSync(path.join(outputPath, `${news._id}.html`),
                        `
                    <!DOCTYPE html>
                    <html lang="pt-br">
                    ...
                    <body class="drawer drawer--right">
                        <div class="wrapper">
                            ...
                            <section class="services-sec newsclass news" id="newsclass">
                                <div class="container">
                                    <h2>${news.heading}<small>${new Date(news.created_at).toLocaleString()}</small>
                                    </h2>
                                    <div class="row">
                                        <div class="col-xs-12 col-md-8">
                                            <div class="col-xs-12 card">
                                                    <img src="${news.img}" class="img-news" alt="${news.heading}">
                                                <div class="col-xs-12 col-md-12 card-text">
                                                    <h4>${news.text}
                                                    </h4>
                                                </div>
                                            </div>
                                        ...
                                        <div class="col-xs-12 col-md-4">
                                            <div class="col-xs-12  card card-side">
                                                <a href="./${previous._id}">
                                                    <div class="col-xs-12 col-md-12 card-img"
                                                        style="background-image:url('${previous.img}');">
                                                    </div>
                                                </a>
                                                <div class="col-xs-12 col-md-12 card-text">
                                                    <h2 class="with-line"><a href="./${previous._id}">${previous.heading}</a></h2>
                                                    <h5><a class="card-button" href="./${previous._id}">Ler
                                                            notícia</a><small>${new Date(previous.created_at).toLocaleString()}</small>
                                                    </h5>
